<template>
  <div v-if="!store.cars[0]">
    <Loader></Loader>
  </div>
  <section v-else class="gallery_display">
  <!-- <section class="gallery_display"> -->
    ...
    <div class="content_container">
        <transition-group name="cards" appear @before-enter="beforeEnter($event)" @enter="enter" @leave="leave">
