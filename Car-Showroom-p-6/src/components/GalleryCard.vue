<template>
    <div class="gallery_card">
        ...
        <div class="car-card-btn-container">
            <router-link :to="{name:'detail', params:{id: car.id}}" :disabled="!car.price"
            ...
            <div class="edit_delete_btn_container">
                ...
                <button type="button" class="car-delete-btn" @click="delete_alert(car.id)">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 448 512">
                        <path
